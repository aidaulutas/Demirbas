...
{
    /// <inheritdoc />
    public partial class CreateSQLiteTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryHistories_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeliveryHistories_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeliveryHistories_Items_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryHistories_DepartmentId",
                table: "DeliveryHistories",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryHistories_EmployeeId",
                table: "DeliveryHistories",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryHistories_ItemId",
                table: "DeliveryHistories",
                column: "ItemId");
